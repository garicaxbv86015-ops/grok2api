...
import { Box, ChevronDown, Eye, Globe2, Image, KeyRound, Languages, LayoutDashboard, LogOut, Menu, MessageSquareText, Monitor, Moon, MoreHorizontal, ScanSearch, Settings, Sparkles, Sun, Users, Video } from "lucide-react";
...
const navigation = [
  ...
  { href: "/account-inspection", label: "nav.accountInspection", icon: ScanSearch },
  { href: "/proxies", label: "nav.proxies", icon: Globe2 },
